...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/garden.css">
    <!-- Text reference: 
...
<!-- Image reference:
"Spring gardening flat composition with characters of gardeners working in outdoor garden scenery with growing vegetables", Freepik. [Online]. Available: https://www.freepik.com/free-vector/spring-gardening-flat-composition-with-characters-gardeners-working-outdoor-garden-scenery-with-growing-vegetables_14665705.htm.
-->
<body background="<?php echo base_url(); ?>images/garden.png">
<?php echo form_open(base_url().'garden'); ?>
<audio src="<?php echo base_url(); ?>bgmusic/garden.mp3" autoplay="autoplay" loop="loop"
       preload="auto"></audio>
       <!-- audio Reference:
        "Scott Joplin, Sunflower Slow Drag, -Classical Remix". [Online]. Available: https://pixabay.com/zh/music/-scott-joplin-sunflower-slow-drag-classical-remix-8579/.
        -->
<section id="gamePlay">
    <!--gamebox-->
...
<!--    <img src="Images/garden.png" alt="Garden background pack">-->

<!-- Image Reference:
"Organic flat design flowers collection", Freepik. [Online]. Available: https://www.freepik.com/free-vector/organic-flat-design-flowers-collection_13218307.htm.
-->
<div id="plant1"><img src="<?php echo base_url(); ?>images/plant%20icon.png" alt="plant icon"></div>
<div id="plant2"><img src="<?php echo base_url(); ?>images/plant%20icon.png" alt="plant icon"></div>
<div id="plant3"><img src="<?php echo base_url(); ?>images/plant%20icon.png" alt="plant icon"></div>
<div id="plant4"><img src="<?php echo base_url(); ?>images/plant%20icon.png" alt="plant icon"></div>
<div id="plant5"><img src="<?php echo base_url(); ?>images/plant%20icon.png" alt="plant icon"></div>
<div id="plant6"><img src="<?php echo base_url(); ?>images/plant%20icon.png" alt="plant icon"></div>
...
<div id="failModal"  class="fail">
    ...
    <div>
        <input type="button" value="Back To Garden" id="tryagain"/>
    </div>
</div>
...
<div id="conModal"  class="congratulation">
    ...
    <h1>Congratulations! You have got a badge</h1>
    ...
    <div id="susbutton">
    <a href="<?php echo base_url();?>badge/updategotobadgepagegarden"><input type="button" value="View badges" id="conbutton"/></a>
    <a href="<?php echo base_url();?>badge/updategardenbadge"><input type="button" value="Back to the garden" id="conbutton"/></a>
    </div>
</div>

</body>
<script src="<?php echo base_url(); ?>assets/js/jquery-3.6.0.js"></script>
<script src="<?php echo base_url(); ?>assets/js/GardenPage.js"></script>
</html>