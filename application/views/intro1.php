...
<body>
<?php echo form_open(base_url().'intro1'); ?>
<!-- audio Reference
...
<audio src="<?php echo base_url(); ?>bgmusic/room.mp3" autoplay="autoplay" loop="loop"
       preload="auto"></audio>
<a href="<?php echo base_url();?>intro2">
    <!-- Image Reference: 
    ...
    <img src="<?php echo base_url(); ?>images/information1.jpg" alt="Click to begain" class="background">
    </a>
</body>
