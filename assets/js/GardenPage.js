$(document).ready(function () {
    $('#plant1,#plant2,#plant3,#plant4,#plant5,#plant6').bind('click', function () {
...
function iterateRecords(data) {
    ...
    $.each(data.result.records, function (recordKey, recordValue){
        ...
        if (recordType == "Perennial" || recordType == "Annual" || recordType == "Succulent"){
    ...
    $.each(data.result.records, function (recordKey, recordValue) {
       ...
       /** "Beautiful spring flower set", Freepik. [Online]. Available: https://www.freepik.com/free-vector/beautiful-spring-flower-set_12340556.htm.
        "Succulents icons set", Freepik. [Online]. Available: https://www.freepik.com/free-vector/succulents-icons-set_3887192.htm#page=1&query=Succulent&position=2&from_view=search.
        */
        if (recordName && recordType && recordWater && recordLight && recordHeight && recordSoil && recordId == id) {
            if (recordType == "Perennial"){
                var imgurl = 'images/Perennial.png'
            }
            else if (recordType == "Annual"){
                var imgurl = 'images/Annual.png'
            }else {
                var imgurl = 'images/Succulent.png'
            }
            $(".records").append(
...
$("#sandselections").click(function (e) {
    ...
    if (list[5].length > 4) {
        ...
        if (e.target.value == array[0] || e.target.value == array[1] || e.target.value == array[2]) {
            ...
            //$(e.target.value).unbind('mouseenter').unbind('mouseleave');
