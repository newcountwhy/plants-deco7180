$(document).ready(function () {
    $('#plant1,#plant2,#plant3,#plant4,#plant5').bind('click', function () {
...
function iterateRecords(data) {
    ...
    $.each(data.result.records, function (recordKey, recordValue) {
       ...
       /** "Watercolor vesak concept", Freepik. [Online]. Available: https://www.freepik.com/free-vector/watercolor-vesak-concept_7468044.htm#page=1&query=lotus&from_query=nymphaea&position=47&from_view=search.
       */
        if (recordName && recordType && recordWater && recordLight && recordHeight && recordSoil && recordId == id) {
            $(".records").append(
                ...
                $('<img id="plantImage">').attr('src','images/Aquatic.png'),
